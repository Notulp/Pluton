...
namespace Pluton
{
    public class BasePlugin : CountedInstance, IPlugin
    {
        ...
        public IDisposable OnLandmineArmedHook;

        public void OnLandmineArmed(Landmine l)
        {
            this.Invoke("On_LandmineArmed", l);
        }

        public IDisposable OnLandmineExplodedHook;

        public void OnLandmineExploded(Landmine l)
        {
